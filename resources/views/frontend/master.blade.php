            ...
            <div class="col-md-8 content-main">
                <div class="content-grid">
                    ...
                    <div class="content-grid-info">
                        ...
                        <div class="post-info">
                            <h4><a href="/post/{{$post->id}}">{{$post->title}}</a>{{ \Carbon\Carbon::parse($post->created_at)->toFormattedDateString() }} / {{count($post->comments)}} Comments</h4>
                            <p>{{$post->body}}</p>
            ...
            <div class="col-md-4 content-right">
                <div class="recent">
                    ...
                    <ul>
                        ...
                        <li><a href="#">{{$postTitle->title}}</a></li>
                        @endforeach
                    </ul>
                </div>
                <div class="comments">
